...
function PACMAN (initX, initY) {
  ...
  this.PacmanEyeX = (0);
  this.PacmanEyeY = (0);
  this.PacmanEyeDiaX = (0);
  this.PacmanEyeDiaY = (0);
  this.posX = initX;
  this.posY = initY;
  this.dirX = 1;
  this.dirY = 0;
...
PACMAN.prototype.drawPacMan = function (){
  ...
  this.PacmanEyeY = 0 - this.PacmanDiam * (1/6);
	this.PacmanEyeX = this.PacmanDiam * (1/6);
	this.PacmanEyeDiaX = this.PacmanDiam/10;
	this.PacmanEyeDiaY = this.PacmanDiam/5;
  pop();
}
